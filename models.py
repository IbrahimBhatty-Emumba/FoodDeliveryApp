...
class OrderItemsM2M(models.Model):
    orderitems_id = models.AutoField(primary_key=True)
    item = models.ForeignKey(MenuItems, models.DO_NOTHING, blank=True, null=True)
    order = models.ForeignKey('Orders', models.DO_NOTHING, blank=True, null=True)

    class Meta:
        managed = False
        db_table = 'order_items_m2m'


class Orders(models.Model):
    order_id = models.AutoField(primary_key=True)
    restaurant = models.ForeignKey('Restaurant', models.DO_NOTHING)
    driver = models.ForeignKey(DeliveryDrivers, models.DO_NOTHING)
